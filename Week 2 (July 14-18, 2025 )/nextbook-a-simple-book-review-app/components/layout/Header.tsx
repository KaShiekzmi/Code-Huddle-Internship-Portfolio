          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            {isAuthenticated ? (
              ...
              <button
                ...
                className="flex items-center space-x-1 bg-orange-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-orange-700 transition-colors duration-200"
              >
              ...
              <div className="border-t border-gray-200 pt-4">
                {isAuthenticated ? (
                  <div className="space-y-2">
                    ...
                    <button
                      onClick={() => signOut()}
                      className="w-full text-left text-gray-700 hover:text-orange-600 hover:bg-gray-50 px-3 py-2 rounded-md text-base font-medium transition-all duration-200"
                    >
                      Sign Out
                    </button>
                  </div>
